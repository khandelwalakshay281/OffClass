...
const SubjectSearchBar = () => {
  ...
  const renderSubjects = () => {
    const filteredList = Object.values(classSubjects)
      .flat()
      .filter((subject) =>
  ...
  return (
    <Flex justify="space-between" align="center" style={{ marginLeft: "auto" }}>
      <div>
        <div
          style={{
            textAlign: "left",
        ...
        >
          ...
          {/* Email sign button */}
          <span>Drop us an email at offclass@gmail.com</span>{" "}
          {/* Text below search bar */}
        </div>
      </div>

      <div>
        <Image src={img1} id="img1" boxSize="350px" mr="0px" mt="-50px" />
      </div>
    </Flex>
  );
};
